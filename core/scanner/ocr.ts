...
const ITEM_SKIP_KEYWORDS = [
  ...
  // ใบเสร็จ ATM/ธนาคาร: ยอดคงเหลือคือยอดในบัญชี ไม่ใช่รายการที่จ่าย
  'ยอดคงเหลือ',
  // สถานีน้ำมัน: หัวจ่ายคือเลขหัวจ่าย, บัตรเครดิต/เดบิตคือช่องทางชำระเงิน
  'หัวจ่าย', 'บัตรเครดิต', 'บัตรเดบิต',
];
